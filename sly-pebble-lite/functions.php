...
if (!function_exists('sly_pebble_lite_enqueue_assets')) {
	function sly_pebble_lite_enqueue_assets() {
		...
		wp_add_inline_style('sly-pebble-lite-main', '
			...
			.sly-pd-wc .single_add_to_cart_button { border:2px solid #000!important; color:#fff!important; background:#000!important; opacity:1!important; }
			.sly-pd-wc .single_add_to_cart_button:not(.disabled):not([disabled]) { border:2px solid var(--sly-accent)!important; color:#fff!important; background:var(--sly-accent)!important; }
...
require get_template_directory() . '/inc/cart-redesign.php';
