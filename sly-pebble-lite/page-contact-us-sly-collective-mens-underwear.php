...
add_action( 'wp_head', function () {
	...
	/* ── Content card — wraps the_content() and any contact form ───── */
	.sly-cu-wrap{max-width:880px;margin:0 auto;padding:3.5rem 1.5rem 0}
	.sly-cu-card{background:#fff;border:1px solid var(--sly-line);border-radius:var(--sly-radius);padding:clamp(1.75rem,4vw,3.25rem);box-shadow:var(--sly-shadow)}
	...
	.sly-cu-channels{max-width:880px;margin:2.5rem auto 0;padding:0 1.5rem}
	...
	.sly-cu-faq{max-width:880px;margin:2.5rem auto 0;padding:0 1.5rem}
	...
	/* ── CTA — gradient teal ───────────────────────────────────────── */
	.sly-cu-cta{padding:3rem 0 4.5rem}
	.sly-cu-cta__inner{max-width:880px;margin:0 auto;padding:0 1.5rem}
	.sly-cu-cta__panel{background:linear-gradient(120deg,#146a7b 0%,#197E92 50%,#1a8fa5 100%);border-radius:var(--sly-radius);padding:3rem 2.5rem;text-align:center;color:#fff}
...
<section class="sly-cu-hero" data-reveal>
	<div class="container sly-cu-hero__inner">
		<p class="sly-cu-hero__kicker">We're Real People. Seriously.</p>
		<h1 class="sly-cu-hero__title">Get in Touch</h1>
		<p class="sly-cu-hero__sub">No chatbots, no scripts, no hold music. Got a question? Drop us a line — we'll actually read it.</p>
		<div class="sly-cu-chips">
			<span class="sly-cu-chip">📧 Usually Within 24 Hrs</span>
			<span class="sly-cu-chip sly-cu-chip--lime">✅ Real Humans. No Bots.</span>
		</div>
	</div>
</section>
...
<section class="sly-cu-channels" data-reveal>
	<h2 class="sly-cu-channels__title">Other Ways We Can Help</h2>
	<div class="sly-cu-channels__grid">

		<div class="sly-cu-channel" data-reveal>
			<div class="sly-cu-channel__num">01</div>
			<h3 class="sly-cu-channel__title">Email Us Direct</h3>
			<p class="sly-cu-channel__body">Fastest route to a real answer. Tell us what's going on and we'll come back to you — properly.</p>
		...
		<div class="sly-cu-channel" data-reveal>
			...
			<h3 class="sly-cu-channel__title">Returns &amp; Exchanges</h3>
			<p class="sly-cu-channel__body">Got a size issue or need to swap something out? The returns portal is faster than emailing us — most questions are already answered there.</p>
			<a href="<?php echo esc_url( home_url( '/returns/' ) ); ?>" class="sly-cu-channel__link">Returns Portal</a>
		</div>

		<div class="sly-cu-channel" data-reveal>
			<div class="sly-cu-channel__num">03</div>
			<h3 class="sly-cu-channel__title">Size Questions</h3>
			<p class="sly-cu-channel__body">Not sure what to grab? Our size guide has measurements, a full chart, and international sizing. Check it before you order — saves everyone time.</p>
...
<section class="sly-cu-faq" data-reveal>
	<h2 class="sly-cu-faq__title">Before You Hit Send</h2>
	<div class="sly-cu-faq__list">

		<div class="sly-cu-faq__item" data-reveal>
			<p class="sly-cu-faq__q">Where's my order?</p>
			<p class="sly-cu-faq__a">Log in to your account or check the confirmation email we sent — the tracking link is in there. Still stuck? Drop us a line and we'll track it down.</p>
		</div>

		<div class="sly-cu-faq__item" data-reveal>
			<p class="sly-cu-faq__q">Can I swap for a different size?</p>
			<p class="sly-cu-faq__a">Yes. Free size exchanges — no guilt trip, no lecture. Head to our <a href="<?php echo esc_url( home_url( '/returns/' ) ); ?>">Returns &amp; Exchanges page</a> and we'll sort it.</p>
		</div>

		<div class="sly-cu-faq__item" data-reveal>
			<p class="sly-cu-faq__q">Do you ship internationally?</p>
			<p class="sly-cu-faq__a">We ship worldwide. Duties and taxes on international orders are set by your local customs office — that bit's out of our hands, unfortunately.</p>
		</div>
...
<section class="sly-cu-cta">
	<div class="sly-cu-cta__inner">
		<div class="sly-cu-cta__panel" data-reveal>
			...
			<p class="sly-cu-cta__sub">Pouch underwear, pocket styles, quick-dry options — all engineered for the way men actually live.</p>
